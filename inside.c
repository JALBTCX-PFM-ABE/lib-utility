...
static double angle (double x0, double y0, double x1, double y1, 
                         double x2, double y2)
{
  double              xx1, yy1, xx2, yy2, cross, dot, local_angle;
...
/*!
  ...
  - Return Value:       int32_t    =   1 if inside, 0 if not
...
int32_t inside (double *ax, double *ay, int32_t count, double x, double y)
{
  double              angle_sum;
  int32_t             i;
...
int32_t inside_coord2 (NV_F64_COORD2 *xy, int32_t count, double x, double y)
{
  double              angle_sum;
  int32_t             i;
...
int32_t inside_area (AREA area, double x, double y)
{
    double              angle_sum;
    int32_t             i;
...
uint8_t inside_mbr (NV_F64_MBR *mbr, double x, double y)
{
...
uint8_t inside_mbr_coord2 (NV_F64_MBR *mbr, NV_F64_COORD2 xy)
{
...
uint8_t inside_mbr_coord3 (NV_F64_MBR *mbr, NV_F64_COORD3 xyz)
{
...
uint8_t inside_xymbr (NV_F64_XYMBR *mbr, double x, double y)
{
...
uint8_t inside_xymbr_coord2 (NV_F64_XYMBR *mbr, NV_F64_COORD2 xy)
{
...
uint8_t inside_xymbr_coord3 (NV_F64_XYMBR *mbr, NV_F64_COORD3 xyz)
{
