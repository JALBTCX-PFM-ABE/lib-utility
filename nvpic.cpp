...
void
nvPic::setZoomLevel (int32_t level)
{
...
void
nvPic::setZoomPercent (float percent)
{
...
/*!  Zoom in to the specified bounds (see pfm_nvtypes.h for the NV_I32_XYMBR structure definition).
...
nvPic::zoomInPercent ()
{
  if (pic.zoom_level < NVPIC_ZOOM_LEVELS)
    {
      int32_t xsize = pic.bounds[pic.zoom_level].max_x - pic.bounds[pic.zoom_level].min_x;
      int32_t ysize = pic.bounds[pic.zoom_level].max_y - pic.bounds[pic.zoom_level].min_y;


      pic.bounds[pic.zoom_level + 1].min_x = pic.bounds[pic.zoom_level].min_x + NINT (((float) xsize * 
                                                                                       pic.zoom_percent) / 2.0);
      pic.bounds[pic.zoom_level + 1].max_x = pic.bounds[pic.zoom_level].max_x - NINT (((float) xsize *
                                                                                       pic.zoom_percent) / 2.0);


      pic.bounds[pic.zoom_level + 1].min_y = pic.bounds[pic.zoom_level].min_y + NINT (((float) ysize *
                                                                                       pic.zoom_percent) / 2.0);
      pic.bounds[pic.zoom_level + 1].max_y = pic.bounds[pic.zoom_level].max_y - NINT (((float) ysize *
                                                                                       pic.zoom_percent) / 2.0);
  ...
  if (pic.zoom_level)
    {
      ...
      pic.bounds[pic.zoom_level].min_x = pic.bounds[pic.zoom_level + 1].min_x - NINT (((float) xsize *
                                                                                       pic.zoom_percent) / 2.0);
      pic.bounds[pic.zoom_level].max_x = pic.bounds[pic.zoom_level + 1].max_x + NINT (((float) xsize *
                                                                                       pic.zoom_percent) / 2.0);

      if (pic.bounds[pic.zoom_level].min_x < pic.bounds[0].min_x)
        {
          pic.bounds[pic.zoom_level].min_x = pic.bounds[0].min_x;
          pic.bounds[pic.zoom_level].max_x = pic.bounds[pic.zoom_level].min_x + NINT ((float) xsize *
                                                                                      pic.zoom_percent * 2.0);
      ...
      if (pic.bounds[pic.zoom_level].max_x > pic.bounds[0].max_x)
        {
          pic.bounds[pic.zoom_level].max_x = pic.bounds[0].max_x;
          pic.bounds[pic.zoom_level].min_x = pic.bounds[pic.zoom_level].max_x - NINT ((float) xsize *
                                                                                      pic.zoom_percent * 2.0);
      ...
      pic.bounds[pic.zoom_level].min_y = pic.bounds[pic.zoom_level + 1].min_y - NINT (((float) ysize *
                                                                                       pic.zoom_percent) / 2.0);
      pic.bounds[pic.zoom_level].max_y = pic.bounds[pic.zoom_level + 1].max_y + NINT (((float) ysize *
                                                                                       pic.zoom_percent) / 2.0);

      if (pic.bounds[pic.zoom_level].min_y < pic.bounds[0].min_y)
        {
          pic.bounds[pic.zoom_level].min_y = pic.bounds[0].min_y;
          pic.bounds[pic.zoom_level].max_y = pic.bounds[pic.zoom_level].min_y + NINT ((float) ysize *
                                                                                      pic.zoom_percent * 2.0);
      ...
      if (pic.bounds[pic.zoom_level].max_y > pic.bounds[0].max_y)
        {
          pic.bounds[pic.zoom_level].max_y = pic.bounds[0].max_y;
          pic.bounds[pic.zoom_level].min_y = pic.bounds[pic.zoom_level].max_y - NINT ((float) ysize *
                                                                                      pic.zoom_percent * 2.0);
...
void 
nvPic::anchorRubberbandPolygon (int32_t pic_x, int32_t pic_y, QColor color, int32_t line_width, uint8_t close)
{
  int32_t x, y;
...
void 
nvPic::anchorRubberbandPolygon (int32_t x, int32_t y, QColor color, int32_t line_width, uint8_t close, 
                                int8_t q __attribute__ ((unused)))
{
...
void 
nvPic::dragRubberbandPolygon (int32_t pic_x, int32_t pic_y)
{
  int32_t x, y;
...
void 
nvPic::dragRubberbandPolygon (int32_t x, int32_t y, int8_t q __attribute__ ((unused)))
{
...
void 
nvPic::getRubberbandPolygonCurrentAnchor (int32_t *pic_x, int32_t *pic_y)
{
...
void 
nvPic::vertexRubberbandPolygon (int32_t pic_x, int32_t pic_y)
{
  int32_t x, y;
...
void 
nvPic::vertexRubberbandPolygon (int32_t x, int32_t y, int8_t q __attribute__ ((unused)))
{
...
void 
nvPic::getRubberbandPolygon (int32_t *count, int32_t **px, int32_t **py, int32_t **mx, int32_t **my)
{
...
/*!  Close a rubberband polygon in pic space adding the input point (pic_x, pic_y).  Returns the
     ...
     int32_t *mx.  They should be passed to this function as &px.  Remember to "discard"
     the polygon to free the associated allocated memory (returned as px, py, mx, my).  */

void 
nvPic::closeRubberbandPolygon (int32_t pic_x, int32_t pic_y, int32_t *count, int32_t **px, 
...
void 
nvPic::closeRubberbandPolygon (int32_t x, int32_t y, int32_t *count, int32_t **px, int32_t **py, 
                               int32_t **mx, int32_t **my, int8_t q __attribute__ ((unused)))
{
  rubberbandPolyActive = NVFalse;
...
void 
nvPic::anchorRubberbandRectangle (int32_t pic_x, int32_t pic_y, QColor color, int32_t line_width)
{
  int32_t x, y;
...
void 
nvPic::anchorRubberbandRectangle (int32_t x, int32_t y, QColor color, int32_t line_width, 
                                  int8_t q __attribute__ ((unused)))
{
...
void 
nvPic::dragRubberbandRectangle (int32_t pic_x, int32_t pic_y)
{
  int32_t x, y;
...
void 
nvPic::dragRubberbandRectangle (int32_t x, int32_t y, int8_t q __attribute__ ((unused)))
{
...
void 
nvPic::getRubberbandRectangle (int32_t **px, int32_t **py, int32_t **mx, int32_t **my)
{
  *px = rubberbandRectX;
  *py = rubberbandRectY;
...
/*!  Close a rubberband rectangle in pic space.  The ending corner is specified by the point
     ...
     in your calling function as int32_t *px and int32_t *mx.  They should be passed to
     this function as &px.  */

void 
nvPic::closeRubberbandRectangle (int32_t pic_x, int32_t pic_y, int32_t **px, int32_t **py, 
...
/*!  Close a rubberband rectangle in screen space.  The ending corner is specified by the point
     ...
     function as int32_t *px and int32_t *mx.  They should be passed to this function as &px.  */

void 
nvPic::closeRubberbandRectangle (int32_t x, int32_t y, int32_t **px, int32_t **py, int32_t **mx, 
                                 int32_t **my, int8_t q __attribute__ ((unused)))
{
  rubberbandRectActive = NVFalse;
...
void 
nvPic::getRubberbandRectangleAnchor (int32_t *pic_x, int32_t *pic_y)
{
...
void 
nvPic::anchorRubberbandLine (int32_t pic_x, int32_t pic_y, QColor color, int32_t line_width)
{
  int32_t x, y;
...
void 
nvPic::anchorRubberbandLine (int32_t x, int32_t y, QColor color, int32_t line_width, int8_t q __attribute__ ((unused)))
{
...
void 
nvPic::dragRubberbandLine (int32_t pic_x, int32_t pic_y)
{
  int32_t x, y;
...
void 
nvPic::dragRubberbandLine (int32_t x, int32_t y, int8_t q __attribute__ ((unused)))
{
...
void
nvPic::setMovingRectangle (int32_t pic_x0, int32_t pic_y0, int32_t pic_x1, int32_t pic_y1, 
...
void
nvPic::setMovingRectangle (int32_t x0, int32_t y0, int32_t x1, int32_t y1, QColor color, int32_t line_width, 
                           uint8_t filled, int8_t q __attribute__ ((unused)))
{
  floating_object.color = color;
  floating_object.line_width = line_width;
...
void 
nvPic::getMovingRectangle (int32_t **px, int32_t **py, int32_t **mx, int32_t **my)
{
...
void
nvPic::setMovingPolygon (int32_t count, int32_t pic_x[], int32_t pic_y[], QColor color, int32_t line_width,
                         uint8_t filled)
{
...
void
nvPic::setMovingPolygon (int32_t count, int32_t *x, int32_t *y, QColor color, int32_t line_width, uint8_t filled,
                         int8_t q __attribute__ ((unused)))
{
...
void 
nvPic::getMovingPolygon (int32_t *count, int32_t **px, int32_t **py, int32_t **mx, int32_t **my)
{
  getRubberbandPolygon (count, px, py, mx, my);
}
...
void
nvPic::setMovingCircle (int32_t pic_x, int32_t pic_y, int32_t d, float start_angle, 
...
void
nvPic::setMovingCircle (int32_t pic_x, int32_t pic_y, int32_t end_pic_x, int32_t end_pic_y, 
...
void
nvPic::setMovingCircle (int32_t x, int32_t y, int32_t d, float start_angle, float span_angle, 
                        int32_t line_width, QColor color, uint8_t filled, int8_t q __attribute__ ((unused)))
{
  floating_object.color = color;
  floating_object.line_width = line_width;
...
void
nvPic::getMovingCircle (int32_t *pic_x, int32_t *pic_y, int32_t *x, int32_t *y, int32_t *d)
{
  *x = floating_object.x;
  *y = floating_object.y;
...
void 
nvPic::setMovingPath (QPainterPath path, int32_t pic_center_x, int32_t pic_center_y, int32_t line_width,
...
void 
nvPic::setMovingPath (QPainterPath path, int32_t center_x, int32_t center_y, int32_t line_width, QColor color,
                      QBrush brush, uint8_t filled, double angle, int8_t q __attribute__ ((unused)))
{
  floating_object.color = color;
  floating_object.line_width = line_width;
...
void
nvPic::drawText (QString string, int32_t pic_x, int32_t pic_y, double angle, int32_t size, QColor color)
{
  int32_t x, y;
...
void
nvPic::drawText (QString string, int32_t x, int32_t y, double angle, int32_t size, QColor color, 
                 int8_t q __attribute__ ((unused)))
{
  painter.save ();
...
void
nvPic::drawText (QString string, int32_t pic_x, int32_t pic_y, QColor color)
{
  int32_t x, y;
...
void
nvPic::drawText (QString string, int32_t x, int32_t y, QColor color, int8_t q __attribute__ ((unused)))
{
...
void
nvPic::drawLine (int32_t pic_x0, int32_t pic_y0, int32_t pic_x1, int32_t pic_y1,
                 QColor color, int32_t line_width, uint8_t flush)
{
  int32_t x0, y0, x1, y1;
...
void
nvPic::drawLine (int32_t x0, int32_t y0, int32_t x1, int32_t y1, QColor color, int32_t line_width, uint8_t flush,
                 int8_t q __attribute__ ((unused)))
{
  QPen pen;
  pen.setColor (color);
...
void
nvPic::drawCircle (int32_t pic_x, int32_t pic_y, int32_t d, float start_angle, 
...
void
nvPic::drawCircle (int32_t pic_x, int32_t pic_y, int32_t end_pic_x, int32_t end_pic_y, 
...
void
nvPic::drawCircle (int32_t x, int32_t y, int32_t d, float start_angle, float span_angle,
                   int32_t line_width, QColor color, int8_t q __attribute__ ((unused)))
{
  //  Center the circle.
...
void
nvPic::fillCircle (int32_t pic_x, int32_t pic_y, int32_t d, float start_angle, 
...
void
nvPic::fillCircle (int32_t pic_x, int32_t pic_y, int32_t end_pic_x, int32_t end_pic_y, 
...
void
nvPic::fillCircle (int32_t x, int32_t y, int32_t d, float start_angle, float span_angle,
                   QColor color, int8_t q __attribute__ ((unused)))
{
  //  Center the circle.
...
void 
nvPic::fillRectangle (int32_t pic_x, int32_t pic_y, int32_t w, int32_t h, QColor color, uint8_t flush)
{
  int32_t x, y;
...
void
nvPic::fillRectangle (int32_t x, int32_t y, int32_t w, int32_t h, QColor color, uint8_t flush, 
                      int8_t q __attribute__ ((unused)))
{
...
void
nvPic::drawRectangle (int32_t pic_x0, int32_t pic_y0, int32_t pic_x1, int32_t pic_y1,
                    QColor color, int32_t line_width)
{
  int32_t x0, y0, x1, y1;
...
void
nvPic::drawRectangle (int32_t x0, int32_t y0, int32_t x1, int32_t y1, QColor color, int32_t line_width, 
                      int8_t q __attribute__ ((unused)))
{
...
void
nvPic::fillPolygon (int32_t count, int32_t pic_x[], int32_t pic_y[], QColor color)
{
...
void
nvPic::fillPolygon (int32_t count, int32_t x[], int32_t y[], QColor color, int8_t q __attribute__ ((unused)))
{
  //  Don't outline the rectangle
...
void
nvPic::drawPolygon (int32_t count, int32_t pic_x[], int32_t pic_y[], QColor color, int32_t line_width)
{
  int32_t *x = (int32_t *) calloc (count + 1, sizeof (int32_t));
  int32_t *y = (int32_t *) calloc (count + 1, sizeof (int32_t));
...
void
nvPic::drawPolygon (int32_t count, int32_t x[], int32_t y[], QColor color, int32_t line_width, 
                    int8_t q __attribute__ ((unused)))
{
...
void 
nvPic::drawPath (QPainterPath path, int32_t pic_center_x, int32_t pic_center_y, int32_t line_width, QColor color,
...
void 
nvPic::drawPath (QPainterPath path, int32_t center_x, int32_t center_y, int32_t line_width, QColor color,
                 QBrush brush, uint8_t filled, int8_t q __attribute__ ((unused)))
{
...
void 
nvPic::pixmapPaint (int32_t x, int32_t y, QPixmap *src, int32_t src_x, int32_t src_y, int32_t src_w, int32_t src_h)
{
...
QPixmap 
nvPic::grabPixmap (int32_t x, int32_t y, int32_t w, int32_t h)
{
...
void 
nvPic::boundsCheck (int32_t *pic_x, int32_t *pic_y)
{
...
nvPic::resizeEvent (QResizeEvent *e)
{
  ...
  buffer = QPixmap (size ());
  buffer.fill (this->palette ().color (QWidget::backgroundRole ()));
  ...
  if (floating_object.state)
    {
      ...
      if (floating_object.state == NVPIC_OBJECT_ACTIVE)
        {
          int32_t inc = floating_object.line_width / 2 + 1;
          int32_t inc2 = inc * 2;
          int32_t newx, newy;
          QPen pen;
          QRect r;
          ...
          switch (floating_object.type)
            ...
            case NVPIC_MOVE_POLYGON:
              ...
              for (int32_t i = 0 ; i < floating_object.polygon_count ; i++) 
                {
            ...
            case NVPIC_MOVE_PATH:
              ...
              screen_painter.translate (floating_object.x - (int32_t) (r2.width () / 2.0),
                                        floating_object.y - (int32_t) (r2.height () / 2.0));
              ...
              floating_object.prev_rect.setCoords ((int32_t) r2.normalized().x() - inc, 
              ...
              floating_object.prev_rect.translate (floating_object.x - (int32_t) (r2.width () / 2.0), 
                                                   floating_object.y - (int32_t) (r2.height () / 2.0));
...
void 
nvPic::pic_to_screen (int32_t num_points, int32_t pic_x[], int32_t pic_y[], int32_t pix_x[], int32_t pix_y[])
{
      ...
      if (rotate)
        {
          ...
          pix_x[i] = NINT ((((float) (new_x - pic.bounds[pic.zoom_level].min_x) / xrange) * 
                            (float) pic.draw_width) * scale_min_x_scale);
          pix_y[i] = NINT ((((float) (new_y - pic.bounds[pic.zoom_level].min_y) / yrange) * 
                            (float) pic.draw_height) * scale_min_y_scale);
        }
      else
        {
          pix_x[i] = NINT (((float) (pic_x[i] - pic.bounds[pic.zoom_level].min_x) / xrange) * 
                           (float) pic.draw_width);
          pix_y[i] = NINT (((float) (pic_y[i] - pic.bounds[pic.zoom_level].min_y) / yrange) * 
                           (float) pic.draw_height);
        }
    }
}
...
void 
nvPic::screen_to_pic (int32_t num_points, int32_t pic_x[], int32_t pic_y[], int32_t pix_x[], int32_t pix_y[])
{
  for (int32_t i = 0 ; i < num_points ; i++)
    {
      if (rotate)
        {
          ...
          new_x = NINT ((pic.bounds[pic.zoom_level].min_x + ((float) pix_x[i] / (float) pic.draw_width) *
                         xrange) / scale_min_x_scale);
          new_y = NINT ((pic.bounds[pic.zoom_level].min_y + ((float) pix_y[i] / (float) pic.draw_height) * 
      ...
      else
        {
          pic_x[i] = NINT (pic.bounds[pic.zoom_level].min_x + 
                           ((float) pix_x[i] / (float) pic.draw_width) * xrange);
          pic_y[i] = NINT (pic.bounds[pic.zoom_level].min_y + 
                           ((float) pix_y[i] / (float) pic.draw_height) * yrange);
        }
    }
}
  ...
  if (rotate)
    {
      ...
      xrange = (float) ptmp->width ();
      yrange = (float) ptmp->height ();
      ...
      scale_min_x_scale = (float) scaled_pixmap->width () / (float) pic.draw_width;
      scale_min_y_scale = (float) scaled_pixmap->height () / (float) pic.draw_height;
    }
  else
    {
      xrange = (float) pic.width;
      yrange = (float) pic.height;
...
void
nvPic::brighten (int32_t percentage)
{
  if (!pic_loaded) return;
  ...
  int32_t total = tmp->width () * tmp->height ();
  uint32_t *pixels = (uint32_t *) tmp->scanLine (0);


  double mult = (double) percentage * 0.01;
  ...
  if (percentage >= 0)
    {
      for (int32_t i = 0 ; i < 256 ; i++)
        {
          int32_t temp = qMin (255, (int32_t) (i * mult));
          lookup[i] = temp;
        }
    }
  else
    {
      for (int32_t i = 0 ; i < 256 ; i++)
        {
          int32_t temp = qMax (0, (int32_t) (i * mult));
          lookup[i] = temp;
        }
    }
  ...
  if (percentage >= 0)
    {
      for (int32_t i = 0 ; i < total ; i++)
        {
          int32_t r = qRed (pixels[i]);
          int32_t g = qGreen (pixels[i]);
          int32_t b = qBlue (pixels[i]);
...
uint8_t
nvPic::OpenFile (char *filename)
{
  if (pic_loaded) delete orig_pixmap;
...
uint8_t 
nvPic::OpenData (uint8_t *data, uint32_t len)
{
  if (pic_loaded) delete orig_pixmap;
...
void
nvPic::SaveFile (QString filename, uint8_t scaled)
{
  if (!pic_loaded) return;
...
void 
nvPic::RotatePixmap (double angle)
{
  rotation = angle;
  if (rotation != 0.0)
    {
