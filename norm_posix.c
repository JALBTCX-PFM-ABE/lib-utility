...
/*!
   ...
   - Outputs:    double              =   normalized time of record
...
double norm_posix_time (time_t sec, long nsec)
{
    ...
    void cvtime (time_t, long, int32_t *, int32_t *, int32_t *, int32_t *, float *);
    double normtime (int32_t, int32_t, int32_t, int32_t, float);
