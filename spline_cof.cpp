...
void spline_cof (float *x, float *y, int32_t pos, float *coeffs)
{
  int32_t         i;
  float           array_a[SPLINE_COL][SPLINE_ROW], array_d[SPLINE_COL], array_p[SPLINE_COL], array_e[SPLINE_COL], 
  ...
  int32_t posval = pos - 1;

  for (i = 0; i < posval; i++)
    {
      int32_t inv_i = pos - i - 1;
