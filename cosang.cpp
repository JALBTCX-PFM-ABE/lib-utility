...
/******************************************************************************/
static double dot(NV_F64_COORD3 a, NV_F64_COORD3 b)
...
/******************************************************************************/
static double mag(NV_F64_COORD3 a)
...
/******************************************************************************/
NV_F64_COORD3 sun_unv(double azi, double elev)
/*!
...
/******************************************************************************/
double cosang(NV_F64_COORD3 *pt, NV_F64_COORD3 sun)
{
/*!<pre>
...
/* c89 -o cosang cosang.c -DDEBUG_COSANG -DTEST_COSANG -lM */
	...
	double gridinc=50;
	double vert_exag=1;
	double pixlen=gridinc/vert_exag;
	double elev=50;
	double azi=50;
	double pixel=(-100);
	double peast=(-99);
