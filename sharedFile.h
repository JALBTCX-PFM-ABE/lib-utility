...
typedef struct
{
  int32_t     point;                     /*  pfmEdit(3D) point number */
  double      x;                         /*  X position               */
  double      y;                         /*  Y position               */
  float       z;                         /*  Z value                  */
  float       herr;                      /*  Horizontal uncertainty   */
  float       verr;                      /*  Vertical uncertainty     */
  uint32_t    val;                       /*  Validity                 */
  int16_t     pfm;                       /*  PFM number               */
  int16_t     file;                      /*  File number              */
  uint32_t    line;                      /*  Line number (PFM * SHARED_LINE_MULT + line)  */
  uint32_t    rec;                       /*  Ping (record) number     */
  int32_t     sub;                       /*  Beam (subrecord) number  */
  uint8_t     exflag;                    /*  Flag set by external program  */
} SHARED_FILE_STRUCT;
