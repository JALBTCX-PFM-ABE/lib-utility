...
void matrix_mult(double matrix_1[4][4], double matrix_2[4][3], double matrix_out[4][3])
{
  int32_t         i, j, k;             /* loop counters */
  double          temp;
...
void b_spline(double *x_raw, double *y_raw, double *x_params, double *y_params)
{
  int32_t       i;              /* loop counter */
  double        gs[4][3],       /* input matrix */
                coeff[4][3];    /* output matrix */
  double        ms[4][4] =      /* constant matrix */
